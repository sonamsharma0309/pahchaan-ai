    ...
    <div style={{ minHeight: '100vh', background: '#fdf8f0', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '100px 24px 60px' }}>
      <div style={{ width: '100%', maxWidth: 460 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <h2 style={{ fontFamily: 'Playfair Display, serif', fontSize: 28, fontWeight: 900, color: '#1a1410', marginTop: 20, marginBottom: 8 }}>Create Account</h2>
          <p style={{ color: '#8a7560', fontSize: 14 }}>Start building your brand identity today</p>
        </div>
        ...
        <div style={{ padding: '40px', borderRadius: 28, background: 'white', border: '1px solid rgba(201,168,76,0.18)', boxShadow: '0 16px 60px rgba(201,168,76,0.10)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#5c4d3c', marginBottom: 7 }}>Full Name</label>
              <input
                type="text"
                style={inputStyle}
          ...
          <p style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: '#8a7560' }}>
            ...
            <Link to="/login" style={{ color: '#c9a84c', fontWeight: 700, textDecoration: 'none' }}>Login</Link>
          </p>
        </div>
      </div>
    </div>
